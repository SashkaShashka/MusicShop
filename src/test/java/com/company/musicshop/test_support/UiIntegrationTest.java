package com.company.musicshop.test_support;

import com.company.musicshop.MusicShopApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.musicshop.screen")
@ContextConfiguration(classes = {MusicShopApplication.class, UiTestAssistConfiguration.class})
